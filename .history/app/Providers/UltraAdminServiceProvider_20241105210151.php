...
class UltraAdminServiceProvider extends ServiceProvider
{
    ...
    public function boot()
    {
        ...
        $configPath = __DIR__ . '/../../config/ultraadmin.php';
        $targetPath = dirname(__DIR__, 2) . '/config/ultraadmin.php';
        if (!file_exists($targetPath)) {
            copy($configPath, $targetPath);
        }
        ...
        if (is_dir($viewsPath)) {
            $this->app->get('view')->addLocation($viewsPath);
        }
