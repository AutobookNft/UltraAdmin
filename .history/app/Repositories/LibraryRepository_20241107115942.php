...
class LibraryRepository
{
    ...
    {
        try {
            $this->log->info('LibraryRepository update chiamato con:', [
                'id' => $id,
                'data' => $data
            ]);
            ...
            // Recupera i dati aggiornati per conferma
            $updatedLibrary = $this->getLibraryById($id);
            
            $this->log->info('Libreria aggiornata con successo', [
                'id' => $id,
                'updated_data' => $updatedLibrary
            ]);
            
            return $updatedLibrary;
            
        } catch (Exception $e) {
            $this->log->error('Errore in LibraryRepository update:', [
                'error' => $e->getMessage(),
                'id' => $id,
                'data' => $data
            ]);
