...
return [
    ...
    | can be set in the .env file using the variable ULTRA_SECURE_UPLOAD_CONFIG_FILE.
    | By default, it will use "ultra_secure_upload.php".
    */
    'config_file' => 'ultra_secure_upload.php',
